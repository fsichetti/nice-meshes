...
- [FreeImage](https://freeimage.sourceforge.io/) installed.
...
- **mode**: Sets the behaviour of the program. Possible values:
...
- **noiseType**: Sets the type of noise. Possible values:
